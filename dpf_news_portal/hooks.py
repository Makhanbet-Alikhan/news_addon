_MENUS = [
    ...
    {'url': '/announcements', 'sequence': 61,
     'translations': {'en_US': 'Announcements', 'ru_RU': 'Объявления', 'kk_KZ': 'Хабарландырулар'}},
    {'url': '/pre-releases',  'sequence': 62,
     'translations': {'en_US': 'Pre-releases', 'ru_RU': 'Пре-релизы', 'kk_KZ': 'Алдын ала шығарылымдар'}},
]
